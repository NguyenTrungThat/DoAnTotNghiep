...
namespace DoAnTotNghiep
{
    public partial class KhachHang : System.Web.UI.Page
    {
        ...
        string PageName = "KhachHang.aspx";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string vmk_title_page = "QUẢN LÝ KHÁCH HÀNG";
            ...
            if (!IsPostBack)
            {
                ...
                sql_datasource.SelectCommand = "select * from thanh_vien" +
                    " where ma_quyen not in ('Q001','Q002')" + 
                    " order by khoa asc, id_tv asc"
                ;
