<%@ Page Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true"
 CodeBehind="QuanLyTaiKhoan.aspx.cs" Inherits="DO_AN_TOT_NGHIEP.QuanLyTaiKhoan" %>
...
<asp:SqlDataSource ID="sql_datasource_list_quyenhan" runat="server" 
    ConnectionString="<%$ ConnectionStrings:VMK_CONNECTION_STRING %>" 
    SelectCommand="SELECT ma_quyen, ten_quyen FROM quyen_han where ma_quyen in ('Q001','Q002') order by ma_quyen asc"></asp:SqlDataSource>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="data" style="width: 150px">
                            <input type="text" value='<%# Eval("ten_quyen") %>' onclick="this.select()" readonly="readonly" />
                        </td>
    ...
    <asp:Panel ID="panel_them_sua" runat="server" Visible="false">
        <div class="panel-body">
		    ...
		    <table style="width: 100%;" class="vmk_table_form">
                ...
                <tr>
                    <td class="title">EMAIL</td>
                    <td><asp:TextBox ID="txt_email" runat="server" class="txt_email" MaxLength="50" style="width: 100%"></asp:TextBox></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="title">QUYỀN HẠN</td>
                    <td><asp:DropDownList ID="dropdownlist_list_quyenhan" runat="server" style="width: 100%; height: 25px"></asp:DropDownList></td>
                </tr>
                <tr>
                    <td class="title"></td>
                    <td>
